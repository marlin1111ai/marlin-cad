...
- **Sockets** — sampler coupon (`test-prints/socket-tray-sampler.stl`, 6 pockets) pushed; physical gate pending: print on the X1C and test all 12 sockets. Production tray layout (12 pockets in 240mm) undecided; owner picks after the coupon passes.
